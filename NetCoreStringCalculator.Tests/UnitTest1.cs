...
using NetCoreStringCalculator;
using System;

namespace NetCoreStringCalculator.Tests
{
    ...
    public class StringCalculatorTests
    {
        ...
        {
            Assert.Throws<ApplicationException>(() => calc.Add("-1"));
        }

        [Test]
        public void add_multiple_negative_throws()
        {
            Assert.Throws<ApplicationException>(() => calc.Add("-1,-2"));
        }
